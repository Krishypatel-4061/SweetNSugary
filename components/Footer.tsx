 ...
 *
 * Site-wide footer for Sweet N Sugary.
 * Contains three columns: brand info, quick navigation links,
 * and contact details including social media icons.
 */
    ...
    return (
        <footer className="bg-cream-puff text-warm-cocoa py-12 border-t border-warm-cocoa/10">
            <div className="container mx-auto px-6 grid md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <div className="flex flex-col space-y-3 text-sm opacity-80">
                        ...
                        <Link href="/menu" className="hover:text-dusty-rose">Menu</Link>
                        <Link href="/contact" className="hover:text-dusty-rose">Contact</Link>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p className="text-sm opacity-80 leading-relaxed mb-4">
                        ...
                        <a href="mailto:hello@sweetnsugary.com" className="hover:text-dusty-rose">
            ...
            <div className="text-center text-xs opacity-50 mt-12">
                &copy; {new Date().getFullYear()} Sweet N Sugary. All rights reserved.
            </div>
        </footer>
    );
}
